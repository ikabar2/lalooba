  ...
  return (
    <html lang={initialLang} dir={initialLang === "ar" ? "rtl" : "ltr"} suppressHydrationWarning>
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,400;9..144,500;9..144,600&family=Inter:wght@400;500;600;700&family=Cairo:wght@600;700;800;900&family=Tajawal:wght@500;700&display=swap"
          rel="stylesheet"
        />
      </head>
